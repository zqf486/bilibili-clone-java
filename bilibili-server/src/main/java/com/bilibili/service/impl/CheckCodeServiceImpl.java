...
public class CheckCodeServiceImpl implements ICheckCodeService {
    ...
    public CheckCodeVO getCheckCode() {
        ...
        redisUtil.set(CheckCodeConstant.REDIS_KEY_CHECK_CODE + checkCodeKey, shearCaptcha.getCode(), CheckCodeConstant.EXPIRES);
    ...
    public void verifyCheckCode(String checkCodeKey, String checkCode) {
        ...
        // 1.获取原始 checkCode
        String checkCodeRow = redisUtil.get(CheckCodeConstant.REDIS_KEY_CHECK_CODE + checkCodeKey, String.class);
